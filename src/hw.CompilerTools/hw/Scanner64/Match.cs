...
{
    long? Match(SourcePart span, bool isForward = true);
}
...
public sealed class Match : DumpableObject, IMatch
{
    ...
    sealed class NotMatch : DumpableObject, IMatch
    {
        ...
        long? IMatch.Match(SourcePart span, bool isForward)
        {
    ...
    sealed class FindMatch : DumpableObject, IMatch
    {
        ...
        long? SingleMatch(SourcePosition current, SourcePosition start, SourcePosition end, bool isForward)
        {
