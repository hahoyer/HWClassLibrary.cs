        ...
        , IAggregateable<SourcePart>
{
    ...
    [DisableDump]
    public long Length => EndPosition - Position;

    public string Id => Source[new Index64(Position) / EndPosition];
    ...
    SourcePart(Source source, Range64 range)
    {
        Source = source;
    ...
    public SourcePart Overlay(SourcePart? other)
    {
        ...
        return new(Source, new Index64(start)/end);
    }
    ...
    public SourcePart? Intersect(SourcePart other)
    {
        ...
        return end < start? null : new SourcePart(Source, new Index64(start)/end);
    }
    ...
    public SourcePart Combine(SourcePart other)
    {
        ...
        return new(Source, new Index64(Position) / other.EndPosition);
    }
    ...
    public static SourcePart Span(SourcePosition first, SourcePosition other)
    {
        ...
        return new(first.Source, new Index64(first.Position) / other.Position);
    }

    public static SourcePart Span(SourcePosition first, long length)
        => new(first.Source, new Index64(first.Position) / (first.Position + length));
    ...
    public long? Match(IMatch automaton, bool isForward = true) => automaton.Match(this, isForward);
