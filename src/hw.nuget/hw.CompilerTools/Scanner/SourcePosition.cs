...
namespace hw.Scanner
{
    ...
    public sealed class SourcePosition : Dumpable, IEquatable<SourcePosition>
    {
        ...
        public static bool operator<(SourcePosition left, SourcePosition right) => left != null &&
                                                                           right != null &&
        ...
        public bool Equals(SourcePosition other) => !(other is null) && Equals(Source, other.Source) && Position == other.Position;
