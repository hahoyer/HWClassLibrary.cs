...
namespace HWClassLibrary.EF.Utility
{
    ...
    {
        const string GETTER_ACCESS = "http://schemas.microsoft.com/ado/2006/04/codegeneration:GetterAccess";
        const string SETTER_ACCESS = "http://schemas.microsoft.com/ado/2006/04/codegeneration:SetterAccess";
        const string TYPE_ACCESS = "http://schemas.microsoft.com/ado/2006/04/codegeneration:TypeAccess";
        const string METHOD_ACCESS = "http://schemas.microsoft.com/ado/2006/04/codegeneration:MethodAccess";
        const string ACCESS_PROTECTED = "Protected";
        const string ACCESS_INTERNAL = "Internal";
        const string ACCESS_PRIVATE = "Private";
        static readonly Dictionary<string, int> AccessibilityRankIdLookup = new Dictionary<string, int>
                                                                            {
                                                                                {"private", 1},
                                                                                {"internal", 2},
                                                                                {"protected", 3},
        ...
        static void CalculatePropertyAccessibility(MetadataItem item,
        ...
        static string GetAccessibility(MetadataItem item, string name)
        {
        ...
        static string TranslateUserAccessibilityToCSharpAccessibility(string userAccessibility)
        {
