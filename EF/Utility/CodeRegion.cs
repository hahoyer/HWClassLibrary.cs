...
namespace HWClassLibrary.EF.Utility
{
    ...
    {
        const int STANDARD_INDENT_LENGTH = 4;

        readonly DynamicTextTransformation _textTransformation;
        int _beforeRegionLength;
        int _emptyRegionLength;
        int _regionIndentLevel = -1;
        ...
        {
            var indentLevel = _regionIndentLevel;
